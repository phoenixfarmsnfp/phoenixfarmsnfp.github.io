...
tags: [field updates, fall]
thumbnail: "/assets/images/blog_images/9.29.24/1.png"
thumbnail_alt: "Tomato plants producing green tomatoes in fall"
---
...
{% include blog-image.html image="9.29.24/1.png" alt="Tomato plants producing green tomatoes in fall" %}
...
{% include blog-image.html image="9.29.24/2.png" alt="Harvested tomatoes for the community food fridge" %}
...
{% include blog-image.html image="9.29.24/3.png" alt="Green tomatoes picked for ripening indoors" %}

And finally, our onions continue to grow like crazy, and more have sprouted than what we first planted!

{% include blog-image.html image="9.29.24/4.png" alt="Onions growing in the food forest" %}
